...
define([
    ...
    var Collapse = declare([], {
        ...
        show: function() {
            ...
            if (this.transitioning || domClass.con) {
                return;
            }
            ...
            actives = this.parent && query('.collapse.in', this.parent[0]);
            ...
            if (actives && actives.length) {
                ...
                if (!hasData) {
                    support.setData(actives[0], 'collapse', null);
                }
            }
        ...
        transition: function(method, startEvent, completeEvent) {
            var _complete = lang.hitch(this, function() {
                ...
                on.emit(this.domNode, completeEvent + '.bs.collapse', {
                    bubbles: false,
                    cancelable: false
                });
            });

            on.emit(this.domNode, startEvent + '.bs.collapse', {
                bubbles: false,
                cancelable: false
            });
